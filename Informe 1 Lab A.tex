...
\author{Fabián~Mauricio~Villegas-Bonilla,~\IEEEmembership{Estudiante,~ITCR}
        y~,~\IEEEmembership{Estudiante,~ITCR,}
}
...
\begin{abstract}
Para el experimento 1 se utilizo el diodo en diferente circuitos para observar sus caracteristicas de voltaje 
